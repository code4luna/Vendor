  ...
  return (
    <Container className="about-page">
        <div className="about-page">
            ...
            <p>
            Vendor Connects Database is a platform that connects property management companies with reliable vendors, streamlining the process of finding and hiring qualified professionals for various tasks.
            </p>
